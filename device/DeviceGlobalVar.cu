...
__device__ UpdateCacheArea
*
req_cache_update = NULL;
__device__ int *update_map;

__device__ QueryCacheArea
*
req_cache_query = NULL;
...
__device__ CircularQueue
*
queue_bkts_free = NULL;
