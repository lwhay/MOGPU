...
__global__ void DpProcess(int* place_holder_query_dispatch_local, int anchor_idx, int row_start, int row_end, int col_start, int col_end, GConfig * p_config, \
...
__global__ void DistributorKernel(GConfig *dev_p_gconfig, \
        ...
        MemItem<QueryType>* d_qd_obj_pool, CircularQueue* d_queue_idx_anchor_free, QueryType* d_qd_query_type_pool, int* d_qd_anchor_pool, \
