    ...
    void initBuffer() {
        ...
        if (fp && sizeof(DataType) == sizeof(UpdateType)) {
            ...
            for (int i = 0; i < buffer_len; i++) {
                fscanf(fp, "%d %f %f %f %f %f\n", &(((UpdateType *) (&(req_buffer[i])))->oid),
                       &(((UpdateType *) (&(req_buffer[i])))->x), &(((UpdateType *) (&(req_buffer[i])))->y),
                       &(((UpdateType *) (&(req_buffer[i])))->vx), &(((UpdateType *) (&(req_buffer[i])))->vy),
                       &(((UpdateType *) (&(req_buffer[i])))->time));
            }
            fclose(fp);
            fp = NULL;
            ...
            req_buffer = new DataType[buffer_len];
            for (int i = 0; i < buffer_len; i++) {
                fscanf(fp, "%d %f %f %f %f %f\n", &(((QueryType *) (&(req_buffer[i])))->qid),
                       &(((QueryType *) (&(req_buffer[i])))->minX), &(((QueryType *) (&(req_buffer[i])))->minY),
                       &(((QueryType *) (&(req_buffer[i])))->maxX), &(((QueryType *) (&(req_buffer[i])))->maxY),
                       &(((QueryType *) (&(req_buffer[i])))->t));
            }
            fclose(fp);
            fp = NULL;
        } else {
